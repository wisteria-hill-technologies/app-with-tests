...
describe("Increment Decrement App", () => {
  ...
  describe("Counter cannot go below zero",() => {
    const counter = 0;
    const wrapper = setup(null, { counter });

    test("counter should stay 0 even after clicking decrement button when counter is already zero", () => {
      // find decrement button and click
    ...
    test("message should appear when user tries to decrement below 0", () => {
      const message = findByDataTestAttr(wrapper, 'message');
      expect(message.length).toBe(1);
    });
    test("message should disappear when user increment from 0", () => {
